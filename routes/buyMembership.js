...
router.post("/api/buy-membership/payment",jwtVerify,controller2.paymentDetails);
router.post("/api/buy-membership/validate-membership",jwtVerify,controller3.validateMembership)
